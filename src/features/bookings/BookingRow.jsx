...
import { HiArrowDownCircle, HiArrowUpOnSquare, HiEye, HiTrash } from "react-icons/hi2";
...
function BookingRow({ booking }) {
  ...
  return (
    ...
    <Modal>
      ...
      {status === 'unconfirmed' &&  <Menus.Button icon={<HiArrowDownCircle />} onClick={() => {navigate(`/checkin/${bookingId}`)}}>
          Check in
        </Menus.Button>}
